            ...
            try:
                async with AsyncOrdersLocalSession() as session:
                    ...
                    if order_id and shop_id:
                        ...
                        # Customer credit clearing for sales returns is handled directly via return_service when oncredit_amount > 0.
                        # Non-credit refunds (cash/UPI direct payouts) do not alter customer credit/outstanding debt.
                        ic(f"Sales return processed for order {order_ui_id}")
